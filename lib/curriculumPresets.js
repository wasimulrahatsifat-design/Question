...
export const DEFAULT_CURRICULUM_PRESETS = {
  ...
  // ৬. বাংলা / বাংলা ১ম পত্র
  'বাংলা': [
    { id: 'bn_mcq', title: 'সঠিক উত্তরটি খাতায় লিখ', count: 5, marksPerQuestion: 1, enabled: true, isMcq: true },
    { id: 'bn_vocab', title: 'শব্দার্থ লিখ', count: 5, marksPerQuestion: 2, enabled: true, isMcq: false },
    { id: 'bn_fib', title: 'ঘরের ভিতরের শব্দগুলো খালি জায়গায় বসিয়ে বাক্য তৈরি কর', count: 5, marksPerQuestion: 2, enabled: true, isMcq: false },
    { id: 'bn_conjunct', title: 'যুক্তবর্ণ ভেঙে শব্দ ও বাক্য তৈরি কর', count: 4, marksPerQuestion: 3, enabled: true, isMcq: false },
    { id: 'bn_passage_q', title: 'অনুচ্ছেদটি পড়ে নিচের প্রশ্ন গুলোর উত্তর দাও', count: 3, marksPerQuestion: 5, enabled: true, isMcq: false },
    { id: 'bn_poem_q', title: 'কবিতার চরণ পড়ে সংক্ষেপে প্রশ্নের উত্তর দাও', count: 3, marksPerQuestion: 5, enabled: true, isMcq: false },
    { id: 'bn_punctuation', title: 'বিরামচিহ্ন বসিয়ে অনুচ্ছেদটি পুনরায় লিখ', count: 1, marksPerQuestion: 5, enabled: true, isMcq: false },
    { id: 'bn_writing', title: 'রচনা / অনুচ্ছেদ / দরখাস্ত লিখ', count: 1, marksPerQuestion: 10, enabled: true, isMcq: false },
  ],
  'বাংলা ১ম পত্র': [
    { id: 'bn_mcq', title: 'সঠিক উত্তরটি খাতায় লিখ', count: 5, marksPerQuestion: 1, enabled: true, isMcq: true },
    { id: 'bn_vocab', title: 'শব্দার্থ লিখ', count: 5, marksPerQuestion: 2, enabled: true, isMcq: false },
