...
-- ১. সোর্স মেটাডাটা টেবিল তৈরি করুন (অধ্যায়সহ)
...
-- পূর্বের তৈরি টেবিল থাকলে chapters কলামটি যোগ করুন
ALTER TABLE public.exam_sources ADD COLUMN IF NOT EXISTS chapters JSONB DEFAULT '[]'::jsonb;

-- ২. পাবলিক এক্সেস পলিসি এনাবল করুন (ফ্রি ও সহজ ব্যবহারের জন্য)
ALTER TABLE public.exam_sources ENABLE ROW LEVEL SECURITY;

-- পলিসি আগে থেকে বিদ্যমান থাকলে মুছে পুনরায় তৈরি করুন (Idempotent execution)
